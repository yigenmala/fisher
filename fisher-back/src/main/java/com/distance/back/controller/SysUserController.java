package com.distance.back.controller;

import com.distance.back.model.dto.SysUserInfoDTO;
import com.distance.back.model.entity.SysUser;
import com.distance.back.model.query.SysUserVoQuery;
import com.distance.back.service.SysUserService;
import com.distance.common.annotation.SysLog;
import com.distance.common.constants.DistanceServiceNameConstants;
import com.distance.common.constants.SecurityConstants;
import com.distance.common.enums.ResponseCodeEnum;
import com.distance.common.enums.SmsMessageChannnelEnum;
import com.distance.common.enums.SmsTemplateEnum;
import com.distance.common.template.sms.SmsMessageTemplate;
import com.distance.common.util.ApiResult;
import com.distance.common.util.UserUtil;
...
public class SysUserController {
    ...
    @SysLog(serviceId = DistanceServiceNameConstants.Distance_USER_SERVICE, moduleName = MODULE_NAME, actionName = "根据token获取用户信息")
    ...
    @SysLog(serviceId = DistanceServiceNameConstants.Distance_USER_SERVICE, moduleName = MODULE_NAME, actionName = "根据用户名获取用户信息")
    ...
    @SysLog(serviceId = DistanceServiceNameConstants.Distance_USER_SERVICE, moduleName = MODULE_NAME, actionName = "用户信息分页查询")
    ...
    @SysLog(serviceId = DistanceServiceNameConstants.Distance_USER_SERVICE, moduleName = MODULE_NAME, actionName = "修改用户信息")
    ...
    @SysLog(serviceId = DistanceServiceNameConstants.Distance_USER_SERVICE, moduleName = MODULE_NAME, actionName = "删除用户信息")
    ...
    @SysLog(serviceId = DistanceServiceNameConstants.Distance_USER_SERVICE, moduleName = MODULE_NAME, actionName = "主键查询用户信息")
