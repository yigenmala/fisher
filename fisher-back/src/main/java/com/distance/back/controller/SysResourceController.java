...
import com.distance.back.model.dto.SysResourceTree;
import com.distance.back.model.entity.SysResource;
import com.distance.back.service.SysResourceService;
...
public class SysResourceController {
     ...
     * @return
     */
   @SysLog(serviceId = DistanceServiceNameConstants.Distance_USER_SERVICE, moduleName = MODULE_NAME, actionName = "根据token查询当前用户权限的菜单树")
     ...
     * @return
     */
    @SysLog(serviceId = DistanceServiceNameConstants.Distance_USER_SERVICE, moduleName = MODULE_NAME, actionName = "获取所有菜单的树")
    @GetMapping("/tree")
    ...
    @SysLog(serviceId = DistanceServiceNameConstants.Distance_USER_SERVICE, moduleName = MODULE_NAME, actionName = "添加资源信息")
    ...
    @SysLog(serviceId = DistanceServiceNameConstants.Distance_USER_SERVICE, moduleName = MODULE_NAME, actionName = "修改资源信息")
    ...
    @SysLog(serviceId = DistanceServiceNameConstants.Distance_USER_SERVICE, moduleName = MODULE_NAME, actionName = "根据id查询资源信息")
    ...
    @SysLog(serviceId = DistanceServiceNameConstants.Distance_USER_SERVICE, moduleName = MODULE_NAME, actionName = "根据id删除资源信息")
