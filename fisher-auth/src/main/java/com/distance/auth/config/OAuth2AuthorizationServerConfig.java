package com.distance.auth.config;


import com.distance.auth.handler.CustomWebResponseExceptionTranslator;
import com.distance.auth.security.UserDetailsImpl;
import com.distance.common.constants.DistanceServiceNameConstants;
import com.distance.common.constants.MqQueueNameConstant;
import com.distance.common.constants.SecurityConstants;
import com.distance.common.constants.UserConstants;
import com.distance.common.dto.SysLogDTO;
import com.distance.common.enums.OperationStatusEnum;
import com.distance.common.enums.SysLogTypeEnum;
import com.distance.common.util.UrlUtil;
        ...
        return new TokenEnhancer() {
            ...
            public OAuth2AccessToken enhance(OAuth2AccessToken oAuth2AccessToken, OAuth2Authentication oAuth2Authentication) {
                ...
                sysLogDTO
                        ...
                        .setActionName("登录")
                        .setServiceId(DistanceServiceNameConstants.Distance_AUTH)
