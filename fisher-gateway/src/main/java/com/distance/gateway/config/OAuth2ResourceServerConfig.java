package com.distance.gateway.config;


import com.distance.common.config.IgnoreUrlPropertiesConfig;
import com.distance.gateway.auth.endpoint.AuthExceptionEntryPoint;
import com.distance.gateway.auth.handler.CustomAccessDeniedHandler;
